                ...
                if api_key:
                    if not case_loaded:
                        ...
                        system_instruction = (
                            ...
                            "You must also be able to explain and discuss the dashboard's visual charts: "
                            "1) CatBoost Confusion Matrix: evaluated at risk threshold = 0.15 on the holdout test set. "
                            "2) SHAP Beeswarm Plot: shows the global feature importances and direction of impact. "
                            "3) Model Feature Importance Bar Plot (Top 20): ranks the top 20 general features. "
                            "4) SHAP Waterfall Example Plot: illustrates the prediction step-by-step for a holdout instance. "
